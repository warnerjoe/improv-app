      ...
      {questions.length === 0 && (
        <div className="text-center py-12">
          ...
          <button
            ...
            className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-4 px-8 rounded-full text-xl shadow-lg transform transition hover:scale-105"
          >
        ...
        <div className="space-y-4">
          ...
          {questions.map((question) => (
            <button
              ...
              className="w-full text-left p-6 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors group"
            >
        ...
        <div className="space-y-6">
          ...
          {answer && (
            <div className="flex gap-4 justify-center">
              <button
                onClick={reset}
                className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-3 px-6 rounded-full shadow-lg transform transition hover:scale-105"
              >
